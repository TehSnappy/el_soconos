defmodule ElSoconos do
  ...
  @moduledoc ~S"""
  The gateway module for control of a Sonos system. This code is a wrapper for the excellent [Python Soco library](http://docs.python-soco.com/en/latest/index.html)
